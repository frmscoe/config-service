...
export class AuthController {
  ...
  async getUserProfile(@Request() req): Promise<AuthDto> {
    console.log("DEBUG: Request User Data ->", req.user);
    // Use the validated token from JwtAuthGuard (already attached to req.user)
