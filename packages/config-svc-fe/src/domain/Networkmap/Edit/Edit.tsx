...
import { Handle, NodeMouseHandler, NodeProps, Panel, Position, useNodesState, useEdgesState } from 'reactflow';
...
const TypologyNode: React.FunctionComponent<NodeProps & { onNodesChange: any }> = ({ data, id, onNodesChange }) => {
